...
#' @param error a numeric quantifying the random measurement error
#'
#' @return \code{MeasErrorRandom} returns an object of \link[base]{class}
#' "MeasErrorRandom".
#'
#' An object of class \code{Random} is a list containing the substitute
#' variable, the assumed random measurement error in that variable and, the
